...
**Problem:** [Matrix-Similarity-After-Cyclic-Shifts](https://leetcode.com/problems/matrix-similarity-after-cyclic-shifts)
...
Example 1:**Input:** mat = [[1,2,3],[4,5,6],[7,8,9]], k = 4
